...
(function($, Drupal, window, document, undefined) {
  ...
  $(document).ready(function() {
    ...
    if ($('#banners').length) {
      ...
      var language = $('html').attr('lang').replace(/-/g, '');
      var translation = {
        en: "Read more ...",
        de: "mehr lesen…",
        fr: "En savoir plus …",
    ...
    if ($('body').hasClass('page-products')) {
      ...
      $('.read-more').on('click', function(e) {
        e.preventDefault();
        $(this).parents('.product-row').expand();
      })
      $('.product-document-link a, .product-contact-link a').attr('target', '_blank').click(function(e) {
        e.stopPropagation();
      });
    };
